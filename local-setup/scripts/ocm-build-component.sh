...
resolve_component_versions() {
    ...
    kubectl exec $(get_kubectl_exec_flags) ocm-transfer-pod -- ocm transfer componentversion --overwrite ghcr.io/platform-mesh//github.com/kcp-dev/api-syncagent:0.7.0 oci-registry-docker-registry.registry.svc.cluster.local/platform-mesh --recursive
