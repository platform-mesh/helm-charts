...
| keycloakImage.repository | string | `"quay.io/keycloak/keycloak"` | The Keycloak image repository |
| keycloakImage.tag | string | `""` | The Keycloak image tag (defaults to appVersion) |
